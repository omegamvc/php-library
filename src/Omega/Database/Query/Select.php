...
final class Select extends AbstractFetch
{
     ...
     * @return void
     */
    public function __construct($table_name, array $columns_name, Connection $PDO, ?array $options = null)
    {
     ...
     * @return Select
     */
    public static function from(string $table_name, array $column_name, Connection $PDO)
    {
     ...
     * @return self
     */
    public function order(string $column_name, int $order_using = Query::ORDER_ASC, ?string $belong_to = null)
    {
     ...
     */
    public function orderIfNotNull(string $column_name, int $order_using = Query::ORDER_ASC, ?string $belong_to = null): self
    {
     ...
     * with Column if null.
     */
    public function orderIfNull(string $column_name, int $order_using = Query::ORDER_ASC, ?string $belong_to = null): self
    {
