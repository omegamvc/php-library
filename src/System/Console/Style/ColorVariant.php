...
/**
 * Class representing color variants for console styling.
 *
 * This class contains constants for various color variants, including different
 * shades and hues, to be used for styling console output. Each constant holds
 * the hex code of the color, which can be accessed through the provided `getConst` method.
 *
 * It provides a centralized way of managing and referencing color codes throughout
 * the application, improving consistency and ease of maintenance when working with
 * console styles.
 *
 * @category   System
 * @package    Console
...
class ColorVariant
{
    ...
    /**
     * Get the hex code of a color variant constant.
     *
     * This method accepts a string representing the name of a color constant
     * and returns its corresponding hex code value.
     *
     * @param string $name The name of the constant (e.g., "RED", "PINK_50").
     * @return string The hex code associated with the given constant.
     */
    public static function getConst(string $name): string
    {
