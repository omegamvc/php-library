...
use System\Database\Schema\Table\Alter;
use System\Database\Schema\Table\Create as CreateTable;
use System\Database\Schema\Table\Raw;
use System\Database\Schema\Table\Truncate;
