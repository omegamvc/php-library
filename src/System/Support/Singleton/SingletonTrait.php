...
namespace System\Support\Singleton;

use System\Support\Singleton\Exception\ImmutableStateException;
use System\Support\Singleton\Exception\UndefinedSingletonClassException;
...
trait SingletonTrait
{
    ...
    {
        throw new ImmutableStateException('You can not clone a singleton.');
    }
    ...
    {
        throw new ImmutableStateException('You can not deserialize a singleton.');
    }
    ...
    {
        throw new ImmutableStateException('You can not serialize a singleton.');
    }
}
