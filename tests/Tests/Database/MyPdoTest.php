...
/**
 * Unit test class for verifying MyPDO logging behavior.
 *
 * This test case ensures that SQL queries executed through MyPDO are properly logged.
 ...
 */
#[CoversNothing]
class MyPdoTest extends AbstractDatabase
{
    /**
