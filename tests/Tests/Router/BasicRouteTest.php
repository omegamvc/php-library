...
class BasicRouteTest extends TestCase
{
    ...
    public function testItRouteCanBeRender(): void
    {
        ...
        $route_basic  = $this->getResponse('get', '/test');
        $route_number = $this->getResponse('get', '/test/number/123');
        $route_text   = $this->getResponse('get', '/test/text/xyz');
        $route_any    = $this->getResponse('get', '/test/any/xyz+123');
        $route_all    = $this->getResponse('get', '/test/any/xyz 123'); // allow all character
    ...
    public function testItRouteCanBeRenderUsingGroupPrefix(): void
    {
        ...
        $get_one = $this->getResponse('get', '/page/one');
        $get_two = $this->getResponse('get', '/page/two');
