...
/**
 * Tests all validation chain methods and their string rendering.
 */
#[CoversClass(Valid::class)]
class AllValidationTest extends TestCase
{
    /**
     * Test it can render validation string using chain method.
     *
     * @return void
     */
    public function testItCanRenderValidationStringUsingChainMethod(): void
    {
        $rule = new Valid();
        ...
        $this->assertEquals(
            'required|contains,one;two|boolean,strict|max_len,240|min_len,240|exact_len,240|between_len,3;11|alpha|alpha_numeric|alpha_dash|alpha_numeric_dash|alpha_numeric_space|alpha_space|numeric|integer|float|valid_url|url_exists|valid_ip|valid_ipv4|valid_ipv6|valid_cc|valid_name|street_address|iban|date,31/12/1999|min_age,18|max_numeric,50|starts,Z|required_file|extension,png;jpg;gif|equalsfield,other_field_name|guidv4|phone_number|regex,/test-[0-9]{3}/|valid_json_string|valid_array_size_greater,1|valid_array_size_lesser,1|valid_array_size_equal,1',
            (string) $rule
        );
    }

    /**
     * Test it can render invert validation string using chain method.
     *
     * @return void
     */
    public function testItCanRenderInvertValidationStringUsingChainMethod(): void
    {
        $rule = new Valid();
