...
final class ComponentTest extends TestCase
{
     ...
     * @return void
     */
    public function testItCanRenderComponentScope()
    {
     ...
     * @return void
     */
    public function testItCanRenderNestedComponentScope()
    {
        $templator = new Templator(new TemplatorFinder([__DIR__ . '/view/'], ['']), __DIR__);
     ...
     * @return void
     */
    public function testItCanRenderComponentScopeMultyple()
    {
        $templator = new Templator(new TemplatorFinder([__DIR__ . '/view/'], ['']), __DIR__);
     ...
     * @return void
     */
    public function testItThrowWhenExtendNotFoundyield()
    {
        $templator = new Templator(new TemplatorFinder([__DIR__ . '/view/'], ['']), __DIR__);
        try {
     ...
     * @return void
     */
    public function testItCanRenderComponentUsingNamedParameter()
    {
        $templator = new Templator(new TemplatorFinder([__DIR__ . '/view/'], ['']), __DIR__);
     ...
     * @return void
     */
    public function testItCanRenderComponentOppAprocess()
    {
        $templator = new Templator(new TemplatorFinder([__DIR__ . '/view/'], ['']), __DIR__);
